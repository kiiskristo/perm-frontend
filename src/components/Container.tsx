...
export default function Container({ children, showHero = true }: ContainerProps) {
  return (
    <div className="min-h-screen flex flex-col bg-white text-black dark:bg-gray-900 dark:text-white">
      {/* News/Updates Banner */}
      <Banner
        message="Updates around 9PM EST. November 2025 is the latest month!. You can see daily updated cases "
        type="info"
        dismissible={true}
        enabled={true}
        link={{
            ...
            <nav className="container mx-auto px-4 py-6 flex justify-between items-center">
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="hidden md:flex space-x-6">
                  ...
                  <Link href="/visa-bulletin" className="relative">
                    <Button variant="ghost" className="text-white dark:text-gray-200 hover:bg-white/20">
                      Visa Bulletin
                    </Button>
                    {/* "New" badge — hidden for now, uncomment to re-enable
                    <span className="absolute -top-1 -right-1 bg-yellow-400 text-purple-900 text-[10px] font-bold px-1.5 py-0.5 rounded-full leading-none">
                      New
                    </span>
                    */}
                  </Link>
            ...
            <div className="mx-auto prose prose-gray dark:prose-invert">
              ...
              <div className="mb-6 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                <p className="text-yellow-800 dark:text-yellow-200 font-medium">
                  <strong>Current Reality:</strong> PERM applications are taking <strong>335 days</strong> (range: 313-339 days) to process as of 8/31/2026.
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="/visa-bulletin" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm inline-flex items-center gap-1.5">
                    Visa Bulletin
                    {/* "New" badge — hidden for now, uncomment to re-enable
