...
export default function CaseSearchPage() {
  ...
  const [startDate, setStartDate] = useState('2026-03-17');
  ...
  const getMaxEndDate = (startDateValue: string) => {
    if (!startDateValue) return "2026-03-31";
    ...
    const overallMax = new Date("2026-03-31");
          ...
          <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      // If end date is more than 2 weeks from new start date, adjust it
                      if (endDate && newStartDate) {
                        ...
                        if (diffDays > 14 || end < start) {
                          const newEndDate = getMaxEndDate(newStartDate);
            ...
            <div className="mt-8 bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg border border-blue-200 dark:border-blue-800">
              ...
              <ul className="text-blue-700 dark:text-blue-300 space-y-2">
                ...
                <li>• Data includes March 2024 - March 2026 submissions</li>
